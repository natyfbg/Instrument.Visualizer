...
export function SideNav({ state, dispatch }: SideNavProps): JSX.Element {
  ...
  */
  ...
  return (
    <div className="absolute top-0 left-0 bottom-0 w5 z-1 shadow-1 bg-white flex flex-column" style={{ 
      background: 'linear-gradient(to bottom, #96CDFF, #3C64AF)',
      boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.25)',
    }}>

      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat&display=swap" />

          <div className="h3 fw7 f5 flex items-center pl3 bb b--light-gray" style={{ fontFamily: 'Montserrat, sans-serif', textShadow: '2px 2px 4px rgba(0,0,0,0.3)' }}>
            Banh Mi App
      </div>
      <div className="flex-auto" style={{ fontFamily: 'Comic Sans MS', color: '#1C5D99', transition: 'background 0.2s, box-shadow 0.2s',}}>
